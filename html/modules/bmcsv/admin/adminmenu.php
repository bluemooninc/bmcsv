...
//	$tblCol[$currentoption] = 'current';
	...
	echo "<td style='width: 45%; font-size: 10px; text-align: left; color: #2F5376; padding: 0 6px; line-height: 18px;'>
		<a href='http://www.bluemooninc.jp/' target='_blank'>"._AM_bmcsv_SITE."</a></td>";
	...
	echo "<ul>";
	echo "<li id='".$tblCol[1]."'><a href='index.php?mode=". POST_SELECT_MODULE_FORM."'><span>"._AM_MODULEexport."</span></a></li>";
	echo "<li id='".$tblCol[2]."'><a href='index.php?mode=". POST_DB_SELECT_FORM."&action=export'><span>"._AM_SELECTTABLES."</span></a></li>";
	echo "<li id='".$tblCol[3]."'><a href='import.php'><span>"._AM_import."</span></a></li>";
